...
object UpdateManager {
    ...
    fun checkForUpdate(activity: Activity) {
        Thread {
            try {
                ...
                val notes = getLocalizedNotes(json)
    ...
    private fun getLocalizedNotes(json: JSONObject): String {
        val notesObj = json.optJSONObject("releaseNotes") ?: return json.optString("releaseNotes", "")
        val lang = LanguagePrefs.getLanguage(this) ?: "ar" // reuse existing helper if present
        return when (lang) {
