...
-keep class com.latchi.iptv.model.Channel {
    <fields>;
    <methods>;
}

# Keep the CREATOR field necessary for Parcelable implementation
-keepclassmembers class com.latchi.iptv.model.Channel {
...
-keep class com.latchi.iptv.screens.HomeFragment {
    <fields>;
    <methods>;
}

# Preserve the ChannelsProvider class and its fields and methods
-keep class com.latchi.iptv.provider.ChannelsProvider {
    <fields>;
    <methods>;
}
...
-keep class com.latchi.iptv.adapter.ChannelsAdapter {
    <fields>;
    <methods>;
}
...
-keepclassmembers class com.latchi.iptv.provider.ChannelsProvider {
    *;
}
